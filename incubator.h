...
public:
   ...
   /* void loadFromFile(const std::string &filename)
    ...
    {
        Resource *res;
        if (typeid(r) == typeid(Resource))
            res = new Resource(r);
        else if (typeid(r) == typeid(ResourceMateriel))
            res = new ResourceMateriel(static_cast<const ResourceMateriel &>(r));
        else if (typeid(r) == typeid(ResourceHumaine))
            res = new ResourceHumaine(static_cast<const ResourceHumaine &>(r));
